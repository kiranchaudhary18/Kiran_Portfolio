...
function App() {
  ...
  },
  {
  ...
  },
   {
    ...
    // image: 'https://res.cloudinary.com/dnbayngfx/image/upload/v1757909788/meme-generator_hfme4d.png',
    launchLink: 'https://meme-generator-pi-sepia.vercel.app/',
    codeLink: 'https://github.com/kiranchaudhary18/Meme-generator',
  ...
  <div className="container">
    ...
    <div className="skills-grid">
     ...
     <section id="projects" className="projects-section">
            ...
            {projectsData.map((project, index) => (
              ...
              >
                <div className={`project-header bg-gradient-to-br ${project.color}`}>
                  {project.image && (
                    // Image par click event lagayein
                    <div className="project-icon" onClick={() => openModal(project.videoUrl)}>
                ...
                <div className="project-body">
                  ...
                  <div className="project-actions">
                    <a href={project.launchLink} target="_blank" rel="noopener noreferrer" className="action-btn primary">
                      <ExternalLink size={16} /> Launch
                    </a>
                    <a href={project.codeLink} target="_blank" rel="noopener noreferrer" className="action-btn secondary">
                      <Github size={16} /> Code
                    </a>
                  </div>
                </div>
      ...
      {/* Video Modal - Yeh tabhi dikhega jab modalVideoUrl mein koi link hoga */}
      {modalVideoUrl && (
